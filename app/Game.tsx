...
export default function Game() {
  ...
  return <main className="game-shell">{header}<section className={`studio-window studio-window-${screen}`} aria-label="Главное окно игры">{screen === "home" && homeScreen}{screen === "match3" && matchScreen}{screen === "orders" && ordersScreen}{screen === "drawing" && drawingScreen}</section></main>;
}
