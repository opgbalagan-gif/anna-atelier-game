...
export default function Game() {
  ...
  const header = <header className={screen === "match3" ? "topbar topbar-match-hidden" : "topbar"}><div className="brand-lockup"><div className="brand-mark" aria-hidden="true">А</div><div><p className="eyebrow">уютная история мастерской</p><h1>Ателье Анны</h1></div></div>{playerStats}</header>;
